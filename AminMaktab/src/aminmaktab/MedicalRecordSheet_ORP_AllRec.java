 ...
 * @author ABC
 */
public class MedicalRecordSheet_ORP_AllRec extends javax.swing.JInternalFrame {

    /**
     * Creates new form MedicalRecordSheet_ORP_AllRec
     */
    public MedicalRecordSheet_ORP_AllRec() {
        initComponents();
        try
        {
            ...
            if(myFile.exists())
            {
                ...
                while(myRead.hasNextLine())
                {
                    ...
                    if(data.equals("Medical Recordsheet"))
                    {
                        ...
                        myRead.nextLine(), myRead.nextLine(), myRead.nextLine()};
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("MEDICAL RECORDSHEET | ORP");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient's Name", "Date of Examination", "Father's Name", "Category", "Date of Birth", "Age in Years", "Age in Months", "Sex"
            }
        ));
